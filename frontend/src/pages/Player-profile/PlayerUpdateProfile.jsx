...
const PlayerUpdateProfile = () => {
  ...
  return (
    <div className={styles.body_upload} style={{ minHeight: '100vh', background: '#f4f6fb', padding: '3rem 0' }}>
      <div className={styles.container_upload} style={{ maxWidth: 700, margin: '56px auto' }}>
        <div className={styles.profileCard} style={{ boxShadow: '0 4px 32px rgba(35,41,70,0.10)', borderRadius: 32, padding: '3rem 2.5rem', background: '#fff', border: '1.5px solid #e5e7eb' }}>
          <h1 style={{ textAlign: 'center', fontWeight: 800, fontSize: '2.4rem', marginBottom: 36, color: '#232946', letterSpacing: 1 }}>Update Player Profile</h1>
